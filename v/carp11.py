...
model_path = "z:\\nn\\cap9_256-16-16-block128-batch-32_Vidal.nn"
model_path_backup = "z:\\nn\\cap9_256-16-16-block128-batch-32_Vidal_BACKUP.nn"
class ModelClass():
  def __init__(s):
    #take time etc.
    s.title = "Proba"
    ...
    s.n_head = 16 #8 #16 #12 #8 #4 #8 
    s.n_layer = 16 #8 #16 #12 #8 #4 #8
    s.dropout = 0.0
