...
model_path = "z:\\nn\\cap10_256-8h-16l-block160-batch-48.nn"
model_path_backup = "z:\\nn\\cap9_256-8h-16l-block160-batch-48_BACKUP.nn"
class ModelClass():
  def __init__(s):
    #take time etc.
    s.title = "Proba"
...
# hyperparameters
batch_size = 48 # 32 #256 #32 #48 #16 # 32 # how many independent sequences will we process in parallel?
