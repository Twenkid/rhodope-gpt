...
Based on example by Andrej Karapthy 
Extended by Todor Arnaudov (Twenkid) with another tokenizer, save-load model etc.
...
# hyperparameters
batch_size = 32 #256 #32 #48 #16 # 32 # how many independent sequences will we process in parallel?
...
"""
# ------------
n_embd = 256 #128 #128 #32#128 #64 #256 #128 #64 #256 #vector dimensions
